...
self.addEventListener('fetch',event=>{
 ...
 const url=new URL(request.url);if(url.searchParams.has('v')&&url.searchParams.get('v')!=='46.0')return;url.search='';url.hash='';
